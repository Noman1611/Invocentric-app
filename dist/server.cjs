...
function generateInactivityEmailTemplate(userName) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#0a0a0a; border:1px solid #1f1f1f; border-radius:14px; overflow:hidden;">
        ...
        <tr>
          <td style="padding:34px 32px 10px 32px;">
            <div style="font-size:16px; color:#d0d0d0; margin-bottom:14px;">Hi ${userName}, \u{1F44B}</div>
              ...
              <tr>
                <td style="padding:18px 20px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="middle">
                        <span style="font-size:13px; font-weight:bold; color:#ffffff;">\u{1F4CA} InvoCentric</span>
                      </td>
                      <td align="right">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:16px;">
                    <tr>
                      ...
                      <td width="30%" valign="top" style="border-right:1px solid #232323; padding-right:12px;">
                        <div style="background-color:#16301f; border-radius:6px; padding:7px 8px; font-size:11px; color:#22c55e; margin-bottom:6px;">\u{1F3E0} Dashboard</div>
                        <div style="padding:7px 8px; font-size:11px; color:#8a8a8a; margin-bottom:6px;">\u{1F4C4} Invoices</div>
                        <div style="padding:7px 8px; font-size:11px; color:#8a8a8a; margin-bottom:6px;">\u{1F465} Customers</div>
                        <div style="padding:7px 8px; font-size:11px; color:#8a8a8a; margin-bottom:6px;">\u{1F6CD} Products</div>
                        <div style="padding:7px 8px; font-size:11px; color:#8a8a8a; margin-bottom:6px;">\u{1F4C8} Reports</div>
        ...
        <tr>
          <td align="center" style="padding:0 32px 26px 32px; font-size:12px; color:#8a8a8a;">
            \u{1F512} Secure. Fast. Always with you.
          </td>
        </tr>
