 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wv(r,e){return he(r).setPersistence(e)}function Gy(r,e,t,n){return he(r).onIdTokenChanged(e,t,n)}function Wy(r,e,t){return he(r).beforeAuthStateChanged(e,t)}function Hv(r,e,t,n){return he(r).onAuthStateChanged(e,t,n)}function Qv(r){return he(r).signOut()}const Ui="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yv(r,e,t){return yI(r,e,t)}async function yI(r,e,t){if(Ne(r.app))return Promise.reject(rt(r));const n=Qe(r);kd(r,e,ao),await n._initializationPromise;const s=fc(n,t);return await gI(s,n),s._openRedirect(n,e,"signInViaRedirect")}async function Xv(r,e){return await Qe(r)._initializationPromise,hf(r,e,!1)}async function hf(r,e,t=!1){if(Ne(r.app))return Promise.reject(rt(r));const n=Qe(r),s=fc(n,e),o=await new pI(n,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await n._persistUserIfCurrent(o.user),await n._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do extends Vm{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ue(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ue(this.firestore,null,t)}}function sA(){return new uu("serverTimestamp")}const ud="@firebase/firestore",ld="4.14.1";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */In._jsonSchemaVersion="firestore/querySnapshot/1.0",In._jsonSchema={type:ge("string",In._jsonSchemaVersion),bundleSource:ge("string","QuerySnapshot"),bundleName:ge("string"),bundle:ge("string")};const qv={maxAttempts:5};function es(r,e){if((r=he(r)).firestore!==e)throw new V(P.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zv extends jv{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=es(e,this._firestore),n=new Do(this._firestore);return super.get(e).then((s=>new $t(this._firestore,n,t._key,s._document,new Kn(!1,!1),t.converter)))}}function lA(r,e,t){r=Me(r,ct);const n={...qv,...t};(function(o){if(o.maxAttempts<1)throw new V(P.INVALID_ARGUMENT,"Max attempts must be at least 1")})(n);const s=Ks(r);return vv(s,(i=>e(new zv(r,i))),n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hA(r){r=Me(r,ue);const e=Me(r.firestore,ct),t=Ks(e);return Ev(t,r._key).then((n=>xm(e,r,n)))}function dA(r){r=Me(r,Zt);const e=Me(r.firestore,ct),t=Ks(e),n=new Do(e);return Dm(r._query),Tv(t,r._query).then((s=>new In(e,n,r,s)))}function fA(r,e,t){r=Me(r,ue);const n=Me(r.firestore,ct),s=pu(r.converter,e,t),i=Gs(n);return No(n,[cu(i,"setDoc",r._key,s,r.converter!==null,t).toMutation(r._key,fe.none())])}function pA(r,e,t,...n){r=Me(r,ue);const s=Me(r.firestore,ct),i=Gs(s);let o;return o=typeof(e=he(e))=="string"||e instanceof Po?Rm(i,"updateDoc",r._key,e,t,n):Am(i,"updateDoc",r._key,e),No(s,[o.toMutation(r._key,fe.exists(!0))])}function mA(r){return No(Me(r.firestore,ct),[new js(r._key,fe.none())])}function gA(r,e){const t=Me(r.firestore,ct),n=bv(r),s=pu(r.converter,e),i=Gs(r.firestore);return No(t,[cu(i,"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,fe.exists(!1))]).then((()=>n))}function _A(r,...e){r=he(r);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||hd(e[n])||(t=e[n++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(hd(e[n])){const h=e[n];e[n]=h.next?.bind(h),e[n+1]=h.error?.bind(h),e[n+2]=h.complete?.bind(h)}let i,o,c;if(r instanceof ue)o=Me(r.firestore,ct),c=Bs(r._key.path),i={next:h=>{e[n]&&e[n](xm(o,r,h))},error:e[n+1],complete:e[n+2]};else{const h=Me(r,Zt);o=Me(h.firestore,ct),c=h._query;const f=new Do(o);i={next:m=>{e[n]&&e[n](new In(o,f,h,m))},error:e[n+1],complete:e[n+2]},Dm(r._query)}const u=Ks(o);return Iv(u,c,s,i)}function No(r,e){const t=Ks(r);return wv(t,e)}function xm(r,e,t){const n=t.docs.get(e._key),s=new Do(r);return new $t(r,s,e._key,n,new Kn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){rE(_r),Yn(new Tn("firestore",((n,{instanceIdentifier:s,options:i})=>{const o=n.getProvider("app").getImmediate(),c=new ct(new oE(n.getProvider("auth-internal")),new uE(o,n.getProvider("app-check-internal")),WE(o,s),o);return i={useFetchStreams:t,...i},c._setSettings(i),c}),"PUBLIC").setMultipleInstances(!0)),Bt(ud,ld,e),Bt(ud,ld,"esm2020")})();export{dA as A,pA as B,gA as C,lA as D,Nt as G,rA as a,uA as b,Jy as c,bv as d,_A as e,sA as f,Zv as g,fA as h,N_ as i,Xv as j,Qv as k,Ky as l,hA as m,mA as n,Hv as o,cA as p,$v as q,Kv as r,Wv as s,Gv as t,Jv as u,Yv as v,iA as w,oA as x,nA as y,aA as z};
