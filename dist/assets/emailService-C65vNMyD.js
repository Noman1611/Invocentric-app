import{n as p,w as s,y as n,c as d,b as c}from"./index-UkifOeUG.js";function f(t,e,o){const[a,i]=p(o?.in,t,e);return+s(a)==+s(i)}async function g(t){try{const e=d.currentUser,o=e?await e.getIdToken():"",a=await fetch(c("/api/send-email"),{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify(t)});if(!a.ok)throw new Error("Failed to send email");return await a.json()}catch(e){throw console.error("Email service error:",e),e}}const h={invoiceSent:(t,e,o,a)=>({subject:`New Invoice from ${n(e)}`,html:`
      <h2>Hello ${n(t)},</h2>
