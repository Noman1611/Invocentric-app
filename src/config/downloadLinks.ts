...
export const DEFAULT_WINDOWS_DOWNLOAD_URL =
  'https://github.com/Noman1611/Invocentric-app/releases/download/v1.0.14/InvoCentric-Setup.exe';

export const DEFAULT_ANDROID_DOWNLOAD_URL =
  'https://github.com/Noman1611/Invocentric-app/releases/download/v1.0.14/InvoCentric.apk';
